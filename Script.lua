--[[
    ...
    -----------------------------------------------
    (Height reduced to 420px, minimize already included)
--]]
...
-- Reduced height from 550 to 420
mainFrame.Size = UDim2.new(0, 380, 0, 420)
-- Position adjusted accordingly (half of 420 = 210)
...
minimizeButton.MouseButton1Click:Connect(function()
    if contentFrame.Visible then
        ...
        mainFrame.Size = UDim2.new(0, 380, 0, 420)   -- restores to the new reduced height
        minimizeButton.Text = "–"
    end
end)
